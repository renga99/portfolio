...
//    }
     ...
     * @throws Exception
     */
    public String downloadImage(String imageUrl, String path) throws Exception {
        return downloader(imageUrl,path);
    }
     ...
     */
    private String downloader(String imageUrl,String path) throws IOException, NullPointerException, URISyntaxException {
        String fileToDownloadLocation = imageUrl;
        if (fileToDownloadLocation.trim().equals("")) throw new NullPointerException("The element you have specified does not link to anything!");

        URL fileToDownload = new URL(fileToDownloadLocation);
        File downloadedFile = new File(path,fileToDownload.getFile().replaceFirst("/|\\\\", ""));
